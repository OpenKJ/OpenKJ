...
win32 {
    ...
    !contains(QMAKE_TARGET.arch, x86_64) {
        ...
        LIBS += -LC:\gstreamer\1.0\msvc_x86_64\lib -lgstreamer-1.0 -lgstbase-1.0 -lglib-2.0 -lgobject-2.0 -lgstapp-1.0 -lgstaudio-1.0 -lgstpbutils-1.0 -lgstcontroller-1.0 -lgstvideo-1.0 -lwinmm
    }
}
...
QMAKE_TARGET_BUNDLE_PREFIX = org.openkj

...
public:
    ...
    QStringList singers();
    [[nodiscard]] QStringList historySingers() ;
    [[nodiscard]] QString nextSongPath(int singerId) const;
    [[nodiscard]] QString nextSongArtist(int singerId) const;
    [[nodiscard]] QString nextSongTitle(int singerId) const;
    [[nodiscard]] QString nextSongArtistTitle(int singerId) const;
    [[nodiscard]] QString nextSongSongId(int singerId) const;
    [[nodiscard]] int nextSongDurationSecs(int singerId) const;
    [[nodiscard]] int nextSongKeyChg(int singerId) const;
    [[nodiscard]] int nextSongQueueId(int singerId) const;
    [[nodiscard]] int numSongsSung(int singerId) const;
    [[nodiscard]] int numSongsUnsung(int singerId) const;
